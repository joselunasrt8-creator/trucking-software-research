...
Current determination: `BOUNDED_COHORT_AUDIT_PASSED`; `SEMANTIC_BINDING_PARTIALLY_BOUND`; `TEMPORAL_ALIGNMENT_BLOCKED_MISSING_ADMISSIBLE_CENSUS_OBJECT`; `ELIGIBILITY_RULE_NOT_FROZEN`. These are pipeline states, not evidence that any carrier is eligible or that any platform gate is valid or invalid.
